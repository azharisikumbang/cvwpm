...
@section('title', 'Pembuatan Surat Jalan Canvas')
                ...
                <div class="space-y-4 md:space-y-6">
                    <div class="flex items-center p-4 mb-4 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50"
                        ...
                        <div>
                            ...
                            menjadi catatan bagi sales dalam mengetahui muatan canvas.
                        </div>
                    </div>
                    ...
                    <div>
                        <label class=" block mb-2 text-sm font-medium text-gray-900" for="name">
                            Tanggal Keberangkatan Sales</label>
                        <input
                            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 "
                            type="date" name="tanggal_mulai" min="{{ date('Y-m-d') }}">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="sales"
                            ...
                            <option value="{{ $item['id'] }}">{{ $item['nama'] }} / {{ $item['kontak'] }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900" for="name">
                            Wilayah Tujuan</label>
                        <input name="wilayah"
                            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 "
                            type="text" placeholder="jika lebih dari satu, pisahkan dengan koma..">
                    </div>
                </div>
                ...
                <div class="col-span-2">
                    <div class="flex justify-between items-center pb-2 border-b">
                        <div class="block text-sm font-medium text-gray-900">
                            List muatan barang sales (total: <span x-text="barang_dipilih.length"></span> item)
                        </div>
                        <div>
