...
@section('title', 'Riwayat Barang Keluar Pindah Gudang')

@section('breadcrumb')
@include('components.breadcrumb', ['links' => [
route('admin-stock.index') => 'Panel Admin Stock',
route('admin-stock.pindah-gudang.index') => 'Barang Keluar Pindah Gudang'
]])
@endsection
        ...
        <table class="table-content">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center">{{ $item['gudang_tujuan']['nama'] }} ({{
                        $item['gudang_tujuan']['kode_gudang'] }})</td>
