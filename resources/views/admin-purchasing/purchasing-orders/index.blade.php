        ...
        <table class="table-content">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: left">{{ $item['nomor'] }}</td>
                    <td style="text-align: center">{{ date('d/m/Y', strtotime($item['tanggal'])) }}</td>
                    <td style="text-align: center">{{ $item['supplier'] ?? '-' }}</td>
                    <td>
                        <div class="flex justify-center">
                            <a href="{{ route('admin-purchasing.pengajuan-pembelian.show', $item['nomor']) }}"
                                class="text-blue-600 hover:underline">Unduh PDF</a>
                        </div>
                    </td>
                </tr>
                @empty
